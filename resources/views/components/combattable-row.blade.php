<span class="row border-top">
    @if ($combat->hits1 == null AND $combat->hits2 == null)
        <form method="post" class="form-inline w-100"
            ...
            <span class="col-1 text-center"><input class="form-control form-control-sm" style="width: 4em;"  pattern="\d{1,4}" maxlength="4" required name="hits1"></span>
            <span class="col-1 text-center">vs.</span>
            <span class="col-1 text-center"><input class="form-control form-control-sm" style="width: 4em;" pattern="\d{1,4}" maxlength="4" required name="hits2"></span>
